...
data.L <- data.frame(fread("Dflink.csv"),stringsAsFactors=F)
data.L1 <- data.L[,1:3]
		     data.L2 <- data.L[,4:6]
...
tkbgcol <- c("NA","NA","NA","NA","NA","NA","NA","NA","NA","NA","NA","NA","NA","NA","NA","NA","NA","NA","NA","NA","NA","NA","NA","NA")
tkmargin <- 0.01
tkheight <- 0.06
...
tkrectcol <- 2
selrectcol <- 3
rectcols <- c("mRNA:red","miRNA:blue")
